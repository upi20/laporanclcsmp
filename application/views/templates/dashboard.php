...
<head>
	...
	<!-- #FAVICONS -->
	<link rel="shortcut icon" href="<?= base_url() ?>assets/favicon/bg-white/favicon.ico" type="image/x-icon">
	<link rel="icon" href="<?= base_url() ?>assets/favicon/bg-white/favicon.ico" type="image/x-icon">
	...
	<style>
		<?php
		for ($i = 5; $i <= 500; $i += 5) {
			echo " .width$i { max-width: $i" . "px; min-width: $i" . "px; } ";
			echo " .max-width$i { max-width: $i" . "px; } ";
			echo " .min-width$i { min-width: $i" . "px; } ";
		}
		?>
	</style>
			...
			<ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-5">
				<li class="">
					<a href="#" class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown">
						<img src="<?= base_url() ?>assets/img/logosikk.png" class="online" alt="#">
		...
		<div class="login-info">
			<span>
				...
				<a href="javascript:;" id="show-shortcut" data-action="toggleShortcut">
					<img src="<?= base_url() ?>assets/img/logosikk.png" alt="me" class="online" />
					<span>
						<?= $this->session->userdata('data')['nama'] ?>
					</span>
